...
def make_reasoning_v1_configs():
    ...
    configs.train.pretrained_resnet_location = "/projects/katefgroup/vqa3d/2d_models/"
...
class ReasoningV1Model(nn.Module):
    def __init__(self, vocab, configs):
        ...
        import jactorch.models.vision.featnet2D as featnet2D

        self.resnet = featnet2D.resnet34(
            pretrained=True,
            incl_gap=False,
            num_classes=None,
            model_location=configs.train.pretrained_resnet_location,
        )
